...
class Cli {
  ...
  // Vehicle property accepts Car, Truck, and Motorbike objects
  ...
  findVehicleToTow(truck: Truck): void {
    inquirer
      ...
      .then((answers) => {
        ...
        // Checking to see if the selected vehicle is the truck
        if (selectedVehicle === truck) {
          //console log for truck to not tow itself.
      ...
      .prompt([
        {
          ...
          // Options of actions for vehicle
          choices: [
            'Print details',
            'Start vehicle',
            'Accelerate 5 MPH',
